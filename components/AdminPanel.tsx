      ...
      >
        ...
        <div className="ios-scroll px-5 py-4 space-y-6" style={{ maxHeight: "calc(85vh - 60px)" }}>
          ...
          <section>
            ...
            <p className="text-[12px] text-[#8e8e93] mb-3">Outside these hours the kiosk displays a black lockscreen that cannot be dismissed. Currently disabled in code — settings are saved but not enforced.</p>
            <div className="bg-[#f2f2f7] rounded-xl overflow-hidden">
