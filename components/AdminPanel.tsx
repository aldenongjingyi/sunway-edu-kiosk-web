          ...
          <div className="ios-scroll px-5 py-4 space-y-4" style={{ maxHeight: "calc(85vh - 60px)" }}>
            ...
            <section>
              <div className="flex items-center justify-between mb-2">
                <p className="text-[12px] font-semibold text-[#6b6b6b] uppercase tracking-wide">Select Kiosk Node</p>
                {loaded && (
                  <button
                    onClick={() => setShowMap(true)}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[12px] font-medium text-white"
                    style={{ backgroundColor: "#00226B" }}
                  >
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
                      <path d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-1.447-.894L15 9m0 8V9m0 0L9 7" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    View Map
                  </button>
                )}
